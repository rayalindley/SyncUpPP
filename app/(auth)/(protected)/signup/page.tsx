            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="bg-charleston px-2 text-gray-500">Or continue with</span>
                </div>
              </div>
              ...
              <div className="mt-6">
                <form action={signInWithGoogleAction} method="post">
                  <button
                    type="submit"
                    className="flex w-full items-center justify-center gap-3 rounded-md border border-gray-300 bg-charleston px-3 py-1.5 text-sm font-semibold leading-6 text-light shadow-sm hover:bg-raisinblack focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
                  >
