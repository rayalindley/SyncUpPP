...
function Header({ user }: { user: User }) {
  ...
  return (
    <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-charleston bg-eerieblack px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
